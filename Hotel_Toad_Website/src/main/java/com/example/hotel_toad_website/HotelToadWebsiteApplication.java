...
public class HotelToadWebsiteApplication {

    public static void main(String[] args) throws SQLException, ClassNotFoundException {
        SpringApplication.run(HotelToadWebsiteApplication.class, args);
    }

    @RequestMapping("/app")
    public String getCustomer(@RequestParam(value = "firstname") String firstName,
    ...
    //@Bean()
    public void hotelApp() throws ParseException, SQLException, ClassNotFoundException {
